                    ...
                    return function(n, silent) {
                        if (n === undefined) {
                            ...
                            if (settings.invisible) {
								...
								//var widthWithoutScroll = widthWithoutScrollbar(panel_2);
                                var pw = panel_1.width(position-sw).outerWidth();
                                panel_2.width(self.width()-pw-sw2);
								//panel_2.width(scrollwidth);
								
                                splitter.css('left', pw);
								//console.log("widthWithoutScroll:", widthWithoutScroll, "width:", panel_2.width());
                            }
                        }
                        if (!silent) {
